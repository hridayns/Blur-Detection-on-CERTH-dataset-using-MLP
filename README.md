1. Download and install the latest version of Anaconda (Python 3.6) from https://www.anaconda.com/download (Will include numpy,pandas and scikit-learn by default)
